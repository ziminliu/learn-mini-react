...
(function (global, factory) {
  ...
  function reconcileChildren(current, workInProgress, nextChildren, renderExpirationTime) {
    ...
    if (current === null) {
      ...
      // TODO: 将当前组件与该组件在上次更新时对应的Fiber节点比较（也就是俗称的Diff算法），将比较的结果生成新Fiber节点
...
// TODO:复用current
        ...
        // TODO:即可以直接复用前一次更新的子Fiber，不需要新建子Fiber
        didReceiveUpdate = false;
      }
    } else {
      didReceiveUpdate = false;
...
// TODO: 如果当前浏览器帧没有剩余时间，shouldYield会中止循环，直到浏览器有空闲时间后再继续遍历
